...
class App extends React.Component {
  ...
  constructor(props)  {
    super(props);
    this.state = {tasks:[] , vehicles: [], projects: [], brands:[], filter: 'all', openMobileMenu: false, editedTask: null
  ...
  filterVehicles=(selectedCategory , selectedBrand)=>{
    API.getFilterVehicles(selectedCategory , selectedBrand)
        .then((vehicles) =>{
      this.setState({vehicles: vehicles , selectedCategory: selectedCategory , selectedBrand:selectedBrand});
    })
        .catch((errorObj) => {
          this.handleErrors(errorObj);
        });;
  ...
  render() {
    ...
    return(
      <AuthContext.Provider value={value}>
        ...
        <Header showSidebar={this.showSidebar} getPublicTasks = {this.getPublicVehicles}/>
            ...
            <Route path="/public">
              <Row className="vheight-100">
                <Switch>
                  ...
                  <Route render={({match}) => {
                      ...
                      <Col sm={4} bg="light" id="left-sidebar" className="collapse d-sm-block below-nav">
                        ...
                        brands={this.state.brands} getBrands={this.getbrands}
                        selectedBrand={this.state.selectedBrand} selectedCategory={this.state.selectedCategory}
                        applyFilter={this.filterVehicles}/>
                      </Col>
                    </Collapse>;
                  }}/>
                ...
                <Col sm={8} className="below-nav">
                  ...
                  <VehicleList  mode = "public" vehicles = {this.state.vehicles} getPublicVehicles = {this.getPublicVehicles} />
